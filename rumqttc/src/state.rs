...
impl MqttState {
    ...
    pub fn new(protocol: Protocol, max_inflight: u16) -> Self {
        MqttState {
            protocol,
...
mod test {
    ...
    fn build_mqttstate(protocol: Protocol) -> MqttState {
        MqttState::new(protocol, 100)
    }

    #[test]
    fn next_pkid_increments_as_expected() {
        let mut mqtt = build_mqttstate(Protocol::V4);
